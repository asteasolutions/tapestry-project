 ...
 * Main application consisting of four separate sub-projects:
   ...
   * [`viewer`](./viewer) - A standalone web application where a tapestry can be loaded in a view-only mode
